const verificationEmailTemplate = ({ name, url }) => {
    retrun ` <div style="font-family: 'Arial', sans-serif; max-width: 600px; margin: auto; padding: 15px; border-radius: 12px; background: #F8CB46; box-shadow: 0px 4px 15px rgba(0, 0, 0, 0.1); color: #000000;">
    <!-- Header Section -->
